...
type OrderServiceClient interface {
	UpdateOrderStatus(ctx context.Context, in *OrderStatusRequest, opts ...grpc.CallOption) (*OrderStatusResponse, error)
}
...
func (c *orderServiceClient) UpdateOrderStatus(ctx context.Context, in *OrderStatusRequest, opts ...grpc.CallOption) (*OrderStatusResponse, error) {
...
type OrderServiceServer interface {
	UpdateOrderStatus(context.Context, *OrderStatusRequest) (*OrderStatusResponse, error)
...
func (UnimplementedOrderServiceServer) UpdateOrderStatus(context.Context, *OrderStatusRequest) (*OrderStatusResponse, error) {
...
func _OrderService_UpdateOrderStatus_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(OrderServiceServer).UpdateOrderStatus(ctx, req.(*OrderStatusRequest))
	}
